# Demo Rust Lettre async tokio1 native tls

This is a demonstration of the Rust Lettre crate to 
send email asynchronously using tokio1 native tls.
...
```sh
git clone https://github.com/joelparkerhenderson/ddemo-rust-lettre-async-tokio1-native-tls.git
```
...
│       └── ddemo-rust-lettre-async-tokio1-native-tls v0.1.0 (/Users/jph/git/joelparkerhenderson/demo/ddemo-rust-lettre-async-tokio1-native-tls)
│           └── ddemo-rust-lettre-async-tokio1-native-tls feature "default" (command-line)
├── lettre feature "default" (*)
├── lettre feature "hostname"
│   └── lettre feature "default" (*)
├── lettre feature "native-tls"
│   ├── lettre feature "default" (*)
│   └── lettre feature "tokio1-native-tls"
│       └── ddemo-rust-lettre-async-tokio1-native-tls v0.1.0 (/Users/jph/git/joelparkerhenderson/demo/ddemo-rust-lettre-async-tokio1-native-tls) (*)
├── lettre feature "pool"
│   └── lettre feature "default" (*)
